...
export function WishStatistics({ stats, bannerType }: WishStatisticsProps) {
  ...
  const getRateColor = (actualRate: number, expectedRate: number) => {
    if (actualRate > expectedRate) return 'text-green-600 dark:text-green-400';
    if (actualRate < expectedRate) return 'text-red-600 dark:text-red-400';
  ...
  return (
    ...
    >
      ...
      <article className="p-4 border rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700">
        ...
        <p className="text-3xl font-bold mt-2">{stats.totalPulls}</p>
      ...
      <article className="p-4 border rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700">
        ...
        <p className="text-3xl font-bold mt-2">{stats.fiveStars}</p>
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
      ...
      <article className="p-4 border rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700">
        ...
        <p className="text-3xl font-bold mt-2">{stats.fourStars}</p>
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
      ...
      <article className="p-4 border rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700">
        ...
        <p className="text-3xl font-bold mt-2">{stats.threeStars}</p>
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
